...
const SCRAPER_REGISTRY = {
  ...
  'vps-lstv': {
    ...
    module: '../vps-scrapers/scrapers/lstv',
    hasHealthCheck: true,
  ...
  'vps-bbc': {
    ...
    module: '../vps-scrapers/scrapers/bbc',
    hasHealthCheck: true,
    testMethod: 'fetchBBCFixtures',
    testParams: {},
    requiresVPS: true
  ...
  'vps-sky': {
    ...
    module: '../vps-scrapers/scrapers/skysports',
    hasHealthCheck: true,
    testMethod: 'fetchSkyFixtures',
    testParams: {},
    requiresVPS: true
  ...
  'vps-tnt': {
    ...
    module: '../vps-scrapers/scrapers/tnt',
    hasHealthCheck: true,
    testMethod: 'fetchTNTFixtures',
    testParams: {},
    requiresVPS: true
  ...
  'vps-lfotv': {
    ...
    module: '../vps-scrapers/scrapers/livefootballontv',
    hasHealthCheck: true,
    testMethod: 'fetchLFOTVFixtures',
    testParams: {},
    requiresVPS: true
  ...
  'vps-prosoccertv': {
    ...
    module: '../vps-scrapers/scrapers/prosoccertv',
    hasHealthCheck: true,
  ...
  'vps-oddalerts': {
    ...
    module: '../vps-scrapers/scrapers/oddalerts',
    hasHealthCheck: true,
  ...
  'vps-sporteventz': {
    ...
    module: '../vps-scrapers/scrapers/sporteventz',
    hasHealthCheck: true,
  ...
  'vps-wheresthematch': {
    ...
    module: '../vps-scrapers/scrapers/wheresthematch',
    hasHealthCheck: true,
  ...
  'vps-worldsoccertalk': {
    ...
    module: '../vps-scrapers/scrapers/worldsoccertalk',
    hasHealthCheck: true,
